...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CallEscort24 — Independent Escorts Near You – Local Escort" },
      ...
      { property: "og:title", content: "CallEscort24 — Independent Escorts Near You – Local Escort" },
      { name: "twitter:title", content: "CallEscort24 — Independent Escorts Near You – Local Escort" },
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/a282e775-b4c7-4b3b-a291-1c176c5fa472" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/a282e775-b4c7-4b3b-a291-1c176c5fa472" },
